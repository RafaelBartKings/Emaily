         ...
         <body>
            <div style="text-align: center;">
               ...
               <div>
                  ...
                  <a href="${keys.redirectDomain}/api/surveys/thanks" style="margin: 0 10px; padding: 10px 20px; background-color: #dc3545; color: white; text-decoration: none; border-radius: 5px;">No</a>
               </div>
            </div>
         </body>
      </html>
